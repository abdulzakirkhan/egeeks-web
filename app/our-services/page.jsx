      ...
      <section className="mt-20 py-12">
        <div className="container mx-auto px-6">
            ...
            {cardsData.map((card, index) => (
                <div className={`grid ${index === 1 ? "bg-[#23282A] rounded-l-lg rounded-r-xl ps-3" : index === 3 ? "bg-[#23282A] rounded-l-lg rounded-r-xl ps-3" : index === 5 ? "bg-[#23282A] rounded-l-lg rounded-r-xl ps-3" : ""} grid-cols-1 md:grid-cols-12 my-14 lg:grid-cols-12 justify-center items-center`} key={index}>
                    {index % 2 === 0 ? (
